 ...
 * be retrieved using toCharArray() and
 * toString().(字符缓冲实现可以用作Writer。当数据写入流时，缓冲自动增长。数据可以通过toCharArray()和toString()检索。)
 * <P>
...
public class CharArrayWriter extends Writer {
     ...
     * no effect.（This method does not release the buffer, since its contents might
     * still be required。）
     */
    public void close() {
    }
